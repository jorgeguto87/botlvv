...
client.on('message', async msg => {
    ...
    if (msg.body.match === (/Oi|Olá/i) && msg.body.endsWith ('@c.us')) {
    ...
    }; if (msg.body.match === (/Cozinha|Sala|Banheiro|Quarto/i) && msg.body.endsWith('@c.us')) {
        msg.react('👍');
    ...
    if (msg.body.match === (/Versatile|Vigneto|Sicilia|Venezia|Toscana|Vita|Nuvole|Firenze|Eleganza|Sofisticato/i) && msg.body.endsWith('@c.us')) {

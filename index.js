...
const atende = new Date().getHours() < 8 ? 'Humm... \n😒 Já estamos fora do horário de atendimento.\n\n😃 Mas não se preocupe, retornaremos assim que possível!\n\n🕖 _Nosso horário é de segunda a sábado de 08:00hs às 20:00hs._' : new Date().getHours() > 8 ? '😃 Aguarde um momento que logo será atendido.' : new Date.getHours() > 20 ? 'Humm... \n😒 Já estamos fora do horário de atendimento.\n\n😃 Mas não se preocupe, retornaremos assim que possível!\n\n🕖 _Nosso horário é de segunda a sábado de 08:00hs às 20:00hs._':'😃 Aguarde um momento que logo será atendido.';
const saudacao = new Date().getHours() < 12 ? '*Bom diaa!*' : new Date().getHours() < 18 ? '*Boa tarde!*' : '*Boa noite!*';
const domingo = new Date().getDay() === 0 ? '🏖️ *Hoje é Domingo!*\n\n😃 Amanhã logo cedo um de nossos atendentes irá falar com você.\n\n🕖 _Nosso horário é de segunda a sábado de 08:00hs às 20:00hs._' : new Date().getDay() > 0 ? atende: '🏖️ *Hoje é Domingo!*\n\n😃 Amanhã logo cedo um de nossos atendentes irá falar com você.\n\n🕖 _Nosso horário é de segunda a sábado de 08:00hs às 20:00hs._';
